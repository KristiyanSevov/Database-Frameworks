...
public class Config {
    ...
    public static final String TOWNS_EXPORT_JSON = "/files/json/output/towns.json";

    public static final String RACERS_EXPORT_JSON = "/files/json/output/racers.json";

    public static final String RACER_EXPORT_XML = "/files/xml/output/most_wanted.xml";
}
